...
public class ItemController {
    ...
    @PatchMapping("/{itemId}")
    public ItemDto partialUpdate(@RequestHeader("X-Sharer-User-Id") Long ownerId, @PathVariable Long itemId, @Valid @RequestBody ItemPartialUpdateDto itemPartialUpdateDto) {
        log.debug("Update request was received in controller {} with data {}", this.getClass(), itemPartialUpdateDto.toString());
